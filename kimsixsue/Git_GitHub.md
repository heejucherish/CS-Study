- [Git 그리고 GitHub](#git-----github)
  * [1. 시작하기](#1-----)
    + [Version Control System](#version-control-system)
    + [DVCS 분산 버전 관리 시스템](#dvcs-------------)
    + [Git의 역사](#git----)
    + [CLI](#cli)
    + [Git 기초](#git---)
  * [2. Git의 기초](#2-git----)
    ...
    + [리모트 저장소](#-------)
  * [3. Git 브랜치](#3-git----)
  * [4. 분산 환경에서의 Git](#4----------git)
    + [분산 환경에서의 워크플로](#-------------)
      - [Integration-Manager 워크플로](#integration-manager-----)
    + [프로젝트에 기여하기](#----------)
      - [커밋 가이드라인](#--------)
  * [5. Git 서버](#5-git---)
  * [6. [GitHub](https://github.com/)](#6--github--https---githubcom--)
    + [[계정 만들고](https://github.com/signup?source=login) 설정하기](#---------https---githubcom-signup-source-login------)
    + [GitHub 프로젝트에 기여하기](#github-----------)
      - [프로젝트 Fork 하기](#-----fork---)
      - [GitHub 플로우](#github----)
      - [코드 조각](#-----)
    + [GitHub 프로젝트 관리하기](#github----------)
      - [[새 저장소 만들기](https://github.com/new)](#------------https---githubcom-new-)
    + [[알림 페이지](https://github.com/settings/notifications)](#---------https---githubcom-settings-notifications-)
      - [[웹 알림](https://github.com/notifications)](#-------https---githubcom-notifications-)
      - [이메일 알림](#------)
    + [특별한 파일](#------)
      - [README](#readme)
  * [7. Git 도구](#7-git---)
